...
<section class="content">
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">{{trans('roles.Edit')}} Role #{{ $role->id }}</h3>
      <div class="box-tools">
        {!! Form::open([
            'method'=>'DELETE',
                ...
                <div class="col-md-10">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <label class="checkbox-inline"><input type="checkbox" name="permissions[]" value="{{$permission['id']}}" @if (in_array($permission['id'],json_decode($role['permissions'],true))) {{'checked'}} @endif />{{$permission['title']}}</label>
                            @endforeach
                            </div>
                        </div>   
                        </div>                    
